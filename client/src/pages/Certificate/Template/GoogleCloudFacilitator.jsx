  ...
  return (
    <>
      ...
      <div className='flex flex-col gap-3 py-12 items-center'>
        <div className='flex items-center gap-3 flex-wrap justify-center flex-row sm:gap-5'>
          <a
            ...
            className='rounded-2xl w-[150px] h-[35px] hover:border-gray-300 hover:border-2 bg-black hover:bg-white text-white hover:text-black duration-200 font-extrabold flex items-center justify-center'
          >
            Share on X
          </a>
          <div>
        ...
        >
          {({ loading}) => (
            <button
              disabled={loading}
              className='rounded-2xl w-[150px] h-[35px] bg-[#FFBC39] hover:border-gray-300 hover:border-2 hover:bg-white text-white hover:text-[#FFBC39] duration-200 font-extrabold flex items-center justify-center'
            >
